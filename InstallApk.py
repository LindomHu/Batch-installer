...
class InstallApk:
    def __init__(self,root,device,index,DeviceManager):
        ...
        self.button_select_apk.grid(row=index+2,column=5,stick='w')
        ...
        self.button_delete_GVoicelog.grid(row=index+2, column=13, stick='w')

        self.button_pull_GVoicelog = Button(self.root, text="拉GVoice日志", bg="LightSteelBlue", command=self.pull_GVoicelog)
        self.button_pull_GVoicelog.grid(row=index+2, column=14, stick='w')
